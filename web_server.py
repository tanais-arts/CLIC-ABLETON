...
<body>
  ...
  <div id="beat">
    ...
    <video id="noSleepVideo" muted playsinline webkit-playsinline loop
...
// Repli fonctionnant même en HTTP (l'API Wake Lock exige un contexte
// sécurisé, donc échoue silencieusement sur cette page servie en clair) :
// une vidéo muette en boucle empêche aussi l'écran de s'éteindre.
